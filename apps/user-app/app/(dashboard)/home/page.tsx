...
import { FiArrowUp, FiArrowDown, FiClock, FiTrendingUp, FiAlertCircle } from 'react-icons/fi';
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link href="/transfer" className="bg-indigo-50 hover:bg-indigo-100 p-4 rounded-lg text-center transition-all">
              ...
              <Link href="/p2p" className="bg-indigo-50 hover:bg-indigo-100 p-4 rounded-lg text-center transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mx-auto text-indigo-600 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                </svg>
                <p className="text-sm font-medium text-gray-700">Transfer</p>
              </Link>
              <Link href="/transactions" className="bg-indigo-50 hover:bg-indigo-100 p-4 rounded-lg text-center transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mx-auto text-indigo-600 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div key={txn.id} className="flex justify-between items-center p-3 hover:bg-gray-50 rounded-lg transition-all">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-xs text-gray-500">{new Date(txn.time).toLocaleString()}</p>
                      </div>
                    </div>
